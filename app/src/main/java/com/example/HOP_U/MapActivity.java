...
public class MapActivity extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapView.MapViewEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = findViewById(R.id.map_arrow);
        ...
        MapApiData apiData = new MapApiData();
        ArrayList<MapData> dataArr = apiData.getData();

        ArrayList<MapPOIItem> markerArr = new ArrayList<MapPOIItem>();
        for (MapData data : dataArr) {
            final String title = "상담 센터명:  "+data.getName() + "\n주소:  "+ data.getAdress() + "\n 전화번호:  " + data.getNumber();
            MapPOIItem marker = new MapPOIItem();
            marker.setMapPoint(MapPoint.mapPointWithGeoCoord(data.getLatitude(), data.getLongitude()));
            marker.setItemName(title); //마커 말풍선에 나오는 정보 (기관이름)
            markerArr.add(marker);
        }

        //마커 커스텀
        class CustomCalloutBalloonAdapter implements CalloutBalloonAdapter {
            public final View mCalloutBalloon;
            ...
            public View getCalloutBalloon(MapPOIItem poiItem) {
                ((TextView) mCalloutBalloon.findViewById(R.id.consult_title)).setText(poiItem.getItemName());
                ((TextView) mCalloutBalloon.findViewById(R.id.desc)).setText("경기도");
