...
public class Quiz_Fragment1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_quiz_1, container, false);
        ...
        btn_frag1_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Quiz_Commentary_Fragment1 quiz_solution_Fragment1 = new Quiz_Commentary_Fragment1();
                transaction.replace(R.id.quiz_frameLayout, quiz_solution_Fragment1);
                transaction.commit();
            }
        });
