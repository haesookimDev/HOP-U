...
public class Quiz_Fragment2 extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_quiz_2, container, false);
        ...
        btn_frag1_o.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Quiz_Commentary_Fragment2 quiz_solution_Fragment2 = new Quiz_Commentary_Fragment2();
                transaction.replace(R.id.quiz_frameLayout, quiz_solution_Fragment2);
                transaction.commit();
            }
        });
