package com.example.HOP_U.viewModel;
...
import com.example.HOP_U.Data;
import com.example.HOP_U.repository.FirebaseInstanceDatabase;
...
public class DatabaseViewModel extends ViewModel {
    ...
    public LiveData<DataSnapshot> fetchUserStatus;
    public LiveData<DataSnapshot> fetchUserNames;
    public LiveData<DataSnapshot> fetchRecentChat;
    ...
    public LiveData<Boolean> successAddBanUser;
    ...
    public LiveData<DataSnapshot> getChatUserDataSnapshot;
    public LiveData<DatabaseReference> getTokenRefDb;
    public LiveData<Boolean> successAddRecentChatInDatabase;
    ...
    public void fetchUserStatus(String UID){
        fetchUserStatus = instance.fetchUserStatus(UID);
    }
    ...
    public void fetchRecentChat(String UID){fetchRecentChat = instance.fetchRecentChat(UID);}
    ...
    public void addStatusInDatabase(String statusUpdated,Object status, String UID){
        successAddStatusInDatabase = instance.addStatusInDatabase(statusUpdated, status, UID);
    }
    ...
    public void addRecentChatInDatabase(String chat, DataSnapshot dataSnapshot){
        successAddRecentChatInDatabase = instance.addRecentChatInDatabase(chat, dataSnapshot);
    }

    public void addBanUser(DataSnapshot dataSnapshot){
        successAddBanUser = instance.addBanUser(dataSnapshot);
    }
